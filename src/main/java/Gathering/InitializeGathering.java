...
public class InitializeGathering {
    public static void InitializeOre() {
        ...
        resourceManager.addOre(new Ore(ChatColor.GRAY + "Кварцовая руда", 3, itemStackManager.getItem(OreItems.OreItemNames.QUARTZ_ORE.name()), itemStackManager.getItem(OreItems.OreItemNames.QUARTZ_ORE.name()), 80.0, 120,200));
